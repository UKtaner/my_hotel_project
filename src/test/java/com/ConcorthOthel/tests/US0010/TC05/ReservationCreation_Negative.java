package com.ConcorthOthel.tests.US0010.TC05;
...
public class ReservationCreation_Negative {
    ...
    @Test
    public void InvalidCreditCardMonth() throws InterruptedException, IOException {
...
//Select a room and click on "Book Now" button.
        ...
        roomsPage.selectedRoomCheckOut.sendKeys("11/28/2021");
        ...
        Thread.sleep(1000);
        roomsPage.creditCardExpirationYear.sendKeys("2020");
       // ReusableMethods.getScreenshot("invalidYear");
        Thread.sleep(1000);

        roomsPage.creditCardExpirationMonth.sendKeys("January");
        ReusableMethods.getScreenshot("invalidMonth");
        Thread.sleep(1000);
